...
module LoopStack_tb;
    ...
    initial begin
        ...
        if (loop_finished_tb !== 0 || jmp_address_tb !==2) $display("case 1 failed - Expected 0, 2 got %d, %d", loop_finished_tb, jmp_address_tb);
        ...
        if (loop_finished_tb !== 1) $display("case 2 failed - Expected 0 got %d", loop_finished_tb);
        ...
        if (loop_finished_tb !== 0 || jmp_address_tb !==1) $display("case 3 failed - Expected 0, 2 got %d, %d", loop_finished_tb, jmp_address_tb);
        else $display("case 3 passed");
